...
export const MUTATIONS = {
  ...
  CREATE_RESOURCE_GROUP: `
    mutation CreateResourceGroup($name: String!) {
      createResourceGroup(name: $name) { id name origin miembros }
    }
  `,

  RENAME_RESOURCE_GROUP: `
    mutation RenameResourceGroup($id: String!, $name: String!) {
      renameResourceGroup(id: $id, name: $name) { id name origin miembros }
    }
  `,
...
export async function fetchResourceGroups() {
  try {
    return await client.request(`query { resourceGroups { id name origin miembros rootResourceId } }`)
  } catch (error) {
    handleGraphQLError(error)
  }
}
...
export async function createResourceGroup(name) {
  try {
    return await client.request(MUTATIONS.CREATE_RESOURCE_GROUP, { name })
  } catch (error) {
    handleGraphQLError(error)
  }
}

export async function renameResourceGroup(id, name) {
  try {
    return await client.request(MUTATIONS.RENAME_RESOURCE_GROUP, { id, name })
  } catch (error) {
    handleGraphQLError(error)
  }
}
...
export async function deleteResourceGroup(id) {
  try {
    return await client.request(MUTATIONS.DELETE_RESOURCE_GROUP, { id })
  } catch (error) {
    handleGraphQLError(error)
  }
}
