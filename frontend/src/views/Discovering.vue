...
// ── Computed ───────────────────────────────────────────────────────────────
// Recursos lanzables como descubrimiento = Colecciones (es_coleccion: capacidad
// 'descubrir' + recurso-madre + genera_colecciones). Ya no se ata a Web Tree:
// cualquier especie descubridora (Catálogo DCAT, futuros pivote/archivo) aparece.
