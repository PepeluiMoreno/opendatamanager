...
function origenBadge(r) {
  ...
  if (r.origin === 'manifest') return {
    texto: 'manifiesto', clase: 'bg-blue-900 text-blue-300 border border-blue-700',
    tooltip: 'Gestionado por manifiesto versionado: la definición canónica vive en el repo y se reimporta; los cambios manuales pueden marcar conflicto.' }
  if (r.origin === 'seed') return {
    texto: 'seed', clase: 'bg-gray-700 text-gray-400 border border-gray-600',
    tooltip: 'Sembrado por código (seed_resources.py): la definición canónica vive en el repo.' }
  if (r.autoGenerated) return {
