          ...
          <tbody>
            <tr v-for="app in filteredApps" :key="app.id" @click="selectedAppId = app.id"
              ...
              <td class="px-4 py-3 text-right whitespace-nowrap" @click.stop>
                <button @click="toggleActive(app)" :title="app.active ? 'Desactivar' : 'Activar'" class="p-1.5 rounded transition-colors text-gray-400" :class="app.active ? 'hover:text-amber-300 hover:bg-amber-900/20' : 'hover:text-emerald-300 hover:bg-emerald-900/20'">
                ...
                <button @click="openEditApp(app)" title="Editar" class="p-1.5 rounded transition-colors text-blue-400 hover:text-blue-300 hover:bg-blue-900/30">
                  <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                </button>
                <button @click="confirmDeleteApp(app)" title="Borrar" class="p-1.5 rounded transition-colors text-gray-500 hover:text-red-400 hover:bg-red-900/30">
