...
class UpdateResourceInput:
    ...
    resource_collection_id: Optional[str] = strawberry.field(default=None, name="collectionId")


@strawberry.type
class ResourceCollectionType:
    """Agrupación organizativa de recursos (carpeta). origin: organizativa | matriz."""
    id: str
    name: str
    origin: str
...
class ResourceType:
    ...
    resource_collection_id: Optional[str] = strawberry.field(default=None, name="collectionId")
    collection_ids: List[str] = strawberry.field(default_factory=list, name="collectionIds")
